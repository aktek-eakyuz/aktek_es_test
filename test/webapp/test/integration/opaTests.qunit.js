...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/aktek/test/test/integration/FirstJourney",
    "com/aktek/test/test/integration/OutgoingListJourney",
    "com/aktek/test/test/integration/OutgoingObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
